...
import { enqueueRegistration, flushRegistrations, getServerInstance, hasServerStarted, setServerInstance } from "./internal/state.js";
...
export function registerResource(
    ...
    if (server) {
        if (typeof uriOrTemplate === "string") {
            ...
            server.registerResource(name, uriOrTemplate, metadata, readCallback as ReadResourceTemplateCallback);
        }
        return;
    }
